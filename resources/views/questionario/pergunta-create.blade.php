        ...
        <div class="col">
            <div class="card shadow">
                ...
                <div class="card-body pl-md-6 pr-md-6">
                    ...
                    <form method="POST" action="{{route('pergunta.salvar')}}">
