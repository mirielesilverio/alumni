                    ...
                    @endif
                        ...
                        <div class="form-row">
                            <div class="col-lg-12 mb-3">
                                ...
                                @if(isset($evento))
                                    <input type="text" class="form-control" id="titulo" name="titulo" required="" value="{{$evento->titulo}}">
                                @else
                        ...
                        <div class="form-row">
                            <div class="col-lg-4 mb-3">
                                ...
                                @if(isset($evento))
                                    <input type="date" class="form-control" id="data" name="data" required="" value="{{$evento->data}}">
                                @else
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                @if(isset($evento))
                                    <input type="time" class="form-control" id="horarioIn" name="horarioIn" required="" value="{{$evento->horarioIn}}">
                                @else
                                    <input type="time" class="form-control" id="horarioIn" name="horarioIn" required="">
                                @endif
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label for="">Horário de  Fim</label>
                                @if(isset($evento))
                                    <input type="time" class="form-control" id="horarioFin" name="horarioFin" required="" value="{{$evento->horarioFin}}">
                                @else
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="">Quantidade de vagas</label>
                                    <input type="number" class="form-control" min="0" id="qtdVagas" name="qtdVagas" value="{{$evento->qtdVagas}}">
                            @else
                            <div class="offset-md-1 col-md-6 mb-3">
                                <label for="">Quantidade de vagas</label>
                                    <input type="number" class="form-control" min="0" id="qtdVagas" name="qtdVagas">
                            @endif
                            </div>
                        </div>
                        <div class="form-row">
