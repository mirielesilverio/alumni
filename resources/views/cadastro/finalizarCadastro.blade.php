				...
				<div class="col-md-7 card border-0 pr-0 pl-0 shadow pb-2 mt-5 mb-5">
					...
					<div class="card-body">
						...
						<form class="mt-3" action="{{route('cadastro.salvar')}}" method="POST">
							...
							<div class="form-row">
								<div class="col-6 my-1 mt-4">
							      	<div class="input-group rounded-pill border">
							        	...
							        	<input type="text" class="form-control border-0 rounded-pill" id="dataNasc" name="dataNasc" required="" onkeypress="$(this).mask('00/00/0000');" placeholder="Digite sua data de nascimento">
							      	</div>
							    </div>
							...
							<div class="form-row">
								<div class="col-6 my-1 mt-4">
							      	<div class="input-group rounded-pill border">
							        	...
							        	<input type="password" class="form-control border-0 rounded-pill" id="senha" name="senha" placeholder="Digite uma senha" required="">
							      	</div>
							    </div>
						    ...
						    <button class="btn col-8 offset-2 btn-alumni rounded-pill mt-4 mb-2" type="submit">Finalizar <i class="fas fa-chevron-right ml-2"></i></button>
						</form>
